...
{    
    ...
    {   
        ...
        $get_data_verify_leads = $this->call_alpha1("campaign/get-data-verify-leads");
        ...
        {            
            ...
            $array_response[$keyGetDataVerifyLeads]["subject_name"]        = "Subject : Notify Leads checking from Alpha";
            ...
            if(is_null($facebook_account_id) && is_null($google_account_id))
            {
                ...
                $array_response[$keyGetDataVerifyLeads]["remark"]["Not enter Facebook Account ID and Google Account ID."] = "-";
                $array_response[$keyGetDataVerifyLeads]["link"]["Not enter Facebook Account ID and Google Account ID."] = env("ALPHA1")."campaigns/overview/".$campaignId."/edit";
            }
